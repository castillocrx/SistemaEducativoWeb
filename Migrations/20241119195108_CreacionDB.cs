        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Curso_Programa_ProgramaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Evaluacion_Estudiante_EstudianteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgresoEstudiante", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProgresoEstudiante_Curso_CursoId",
                        column: x => x.CursoId,
                        principalTable: "Curso",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProgresoEstudiante_Estudiante_EstudianteId",
                        column: x => x.EstudianteId,
                        principalTable: "Estudiante",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Evaluacion_EstudianteId",
                table: "Evaluacion",
                column: "EstudianteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgresoEstudiante_CursoId",
                table: "ProgresoEstudiante",
                column: "CursoId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgresoEstudiante_EstudianteId",
                table: "ProgresoEstudiante",
                column: "EstudianteId");
